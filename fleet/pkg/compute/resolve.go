...
// and AvailableVCPUs are exposed alongside Pools and Failures because some
...
func ResolveDesiredPools(
	...
	pools, failures := ComputeDesiredPools(logger, profile.Tiers, zones, familyLimits, skuIndex)
