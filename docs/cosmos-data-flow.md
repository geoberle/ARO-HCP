...
Clients constructed through `corecosmosstorage.NewCosmosDatabaseClient` expose
`cosmos_request_units_total` through the component's legacy Prometheus registry.
